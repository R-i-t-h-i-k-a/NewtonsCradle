...
function draw() {
  ...
  line1(bob1.pointA.x,bob1.pointA.y,rope1.position.x,rope1.position.y);
  line2(bob2.pointA.x,bob2.pointA.y,rope2.position.x,rope2.position.y);
  line3(bob3.pointA.x,bob3.pointA.y,rope3.position.x,rope3.position.y);
  line4(bob4.pointA.x,bob4.pointA.y,rope4.position.x,rope4.position.y);
  line5(bob5.pointA.x,bob5.pointA.y,rope5.position.x,rope5.position.y);
